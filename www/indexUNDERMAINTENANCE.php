	...
	<div class="page-header" id="banner" style="height: !important 100px;">
		<div class="row">
			<div class="col-lg-9">
				...
				<h2>Parli-n-grams is under maintenance at the moment.</h2>
...
<footer>
	<div class="row">
		<div class="col-lg-12">
			...
			<p>Last update: <?php echo file_get_contents('./lastupdated');?>.</p>
...
new ShareButton({
	...
	mpdict["all"] = "all MPs";
		...
		for (varCount=0;varCount<startingNo;varCount++){
			...
			$node += '</select>&nbsp;<a href="#" class="btn btn-default" id="removeVar">-</a></p>';
		}
